...
public interface CustomerAccountApprovedRepository extends JpaRepository<CustomerSavingApproved, Integer> {
	...
	//Optional<CustomerSavingApproved> findByAccountStatus(AccountStatus status);// if it's right???
	...
	//Optional<CustomerSavingApproved> findById(String email);//?????
	//Optional<CustomerSavingApproved> findById(String email);
	//Optional<CustomerSavingApproved> findByStatus(AccountStatus status);
